		...
		<div class="col-md-12">
			...
			<div class="box">
				...
				<div class="box-footer">
					...
					<!-- 테스트 url : /sboard/list?page=6&perPageNum=10&searchType=t&keyword=%ED%95%9C%EA%B8%80 -->
...
<form id="jobForm">
  <input type='hidden' name="page" value=${pageMaker.cri.perPageNum}><!-- value값 왜 미리 넣어준 거지? 어차피 페이지 클릭하면 이벤트로 새로 들어가는데? -->
